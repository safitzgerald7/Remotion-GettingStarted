...
export const HarvestScene: React.FC = () => {
  ...
  const scale = interpolate(frame, [0, 270], [0.9, 1], { extrapolateLeft: 'clamp', extrapolateRight: 'clamp' });
    ...
    <div style={containerStyle}>
      <div style={visualStyle}>
        <svg width="200" height="200">
          ...
          <rect x="100" y="50" width="2" height="130" fill="#8B5A2B" />
          ...
          <circle cx="90" cy="80" r="10" fill="#FF0000" />
          <circle cx="105" cy="75" r="10" fill="#FF0000" />
          <circle cx="85" cy="90" r="10" fill="#FF0000" />
          <circle cx="110" cy="85" r="10" fill="#FF0000" />
        </svg>
      </div>
